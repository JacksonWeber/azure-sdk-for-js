...
- Install tsp-client dependencies with `pnpm install`
...
2. **Generate code**
    ...
    **Initialize a new TypeScript DPG library**
    ...
    ```sh
    pnpm tsp-client init -c YOUR_REMOTE_TSPCONFIG_URL
    ```
    ...
    ```sh
    pnpm tsp-client init -c https://github.com/Azure/azure-rest-api-specs/blob/46ca83821edd120552403d4d11cf1dd22360c0b5/specification/cognitiveservices/ContentSafety/tspconfig.yaml
    ```
    ...
    **Re-generate an existing TypeScript DPG library**
    ...
    ---  
    **NOTE**
    The version of typespec-ts is configured in [eng/emitter-package.json](https://github.com/Azure/azure-sdk-for-js/blob/main/eng/emitter-package.json). Change it locally if you need to validate against a different version of typespec-ts.
